...
## 기술 스택
---
<img src ="https://user-images.githubusercontent.com/79756706/172993699-8b330407-af9b-40d0-aaa9-905f3da30191.png" style="width:100%">

사용하는 메인 언어는 TypeScript입니다.
서버 개발을 위한 프레임 워크는 TypeScript를 지원하는 NestJS를 사용하였습니다. 

객체 지향 프로그래밍을 위해 TypeORM을 사용하여 데이터를 맵핑하였습니다.

빠른 검색을 위해 ELK스택, Redis를 사용하였습니다.

배포를 위해 GCP를 사용하고, 쿠버네티스를 통해 CICD를 구축하였습니다.
